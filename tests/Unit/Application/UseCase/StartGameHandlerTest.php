...
use App\Domain\Repository\{GameRepositoryInterface, TeamRepositoryInterface, TeamMemberRepositoryInterface};
...
{
	public function test_start_game_sets_live_and_deadline(): void
	{
