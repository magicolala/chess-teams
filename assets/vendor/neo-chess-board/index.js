...
// Vendored Neo Chess Board implementation matching the npm package API
// Source: @magicolala/neo-chess-board v0.1.0 (bundled locally as AssetMapper
// cannot fetch it from the CDN in CI)
const THEMES = {
  classic: {
    light: "#f0d9b5",
    dark: "#b58863",
...
export { NeoChessBoard }
export default NeoChessBoard
