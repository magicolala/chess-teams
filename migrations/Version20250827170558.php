...
final class Version20250827170558 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id SERIAL PRIMARY KEY NOT NULL, email VARCHAR(180) NOT NULL, roles TEXT NOT NULL --(DC2Type:json)
        , password VARCHAR(255) NOT NULL, display_name VARCHAR(50) DEFAULT NULL, created_at TIMESTAMP NOT NULL --(DC2Type:datetime_immutable)
        )');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL ON "user" (email)');

        $this->addSql('CREATE TABLE game (id CHAR(36) NOT NULL --(DC2Type:uuid)
        , created_by_id INTEGER DEFAULT NULL, status VARCHAR(10) NOT NULL, created_at TIMESTAMP NOT NULL --(DC2Type:datetime_immutable)
        , updated_at TIMESTAMP DEFAULT NULL --(DC2Type:datetime_immutable)
        , turn_duration_sec INTEGER NOT NULL, visibility VARCHAR(16) NOT NULL, fen TEXT NOT NULL, ply INTEGER NOT NULL, turn_team VARCHAR(1) NOT NULL, turn_deadline TIMESTAMP DEFAULT NULL --(DC2Type:datetime_immutable)
        ...
        , game_id CHAR(36) NOT NULL --(DC2Type:uuid)
        , code VARCHAR(16) NOT NULL, expires_at TIMESTAMP DEFAULT NULL --(DC2Type:datetime_immutable)
        ...
        , by_user_id INTEGER DEFAULT NULL, ply INTEGER NOT NULL, uci VARCHAR(255) DEFAULT NULL, san VARCHAR(255) DEFAULT NULL, fen_after TEXT NOT NULL, type VARCHAR(20) NOT NULL, created_at TIMESTAMP NOT NULL --(DC2Type:datetime_immutable)
        ...
        , user_id INTEGER NOT NULL, position INTEGER NOT NULL, active BOOLEAN NOT NULL, joined_at TIMESTAMP NOT NULL --(DC2Type:datetime_immutable)
        ...
        $this->addSql('CREATE TABLE messenger_messages (id SERIAL PRIMARY KEY NOT NULL, body TEXT NOT NULL, headers TEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at TIMESTAMP NOT NULL --(DC2Type:datetime_immutable)
        , available_at TIMESTAMP NOT NULL --(DC2Type:datetime_immutable)
        , delivered_at TIMESTAMP DEFAULT NULL --(DC2Type:datetime_immutable)
        )');
