 ...
 */
final class Version20250825235733 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__game AS SELECT id, created_by_id, status, created_at, updated_at, turn_duration_sec, visibility, fen, ply, turn_team, turn_deadline, result FROM game');
        ...
        , result VARCHAR(16) DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_232B318CB03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO game (id, created_by_id, status, created_at, updated_at, turn_duration_sec, visibility, fen, ply, turn_team, turn_deadline, result) SELECT id, created_by_id, status, created_at, updated_at, turn_duration_sec, visibility, fen, ply, turn_team, turn_deadline, result FROM __temp__game');
        $this->addSql('DROP TABLE __temp__game');
        $this->addSql('CREATE INDEX IDX_232B318CB03A8386 ON game (created_by_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__invite AS SELECT game_id, id, code, expires_at FROM invite');
        ...
        $this->addSql('INSERT INTO invite (game_id, id, code, expires_at) SELECT game_id, id, code, expires_at FROM __temp__invite');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__team_member AS SELECT id, team_id, user_id, position, active, joined_at FROM team_member');
        ...
        , PRIMARY KEY(id), CONSTRAINT FK_6FFBDA1296CD8AE FOREIGN KEY (team_id) REFERENCES team (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6FFBDA1A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO team_member (id, team_id, user_id, position, active, joined_at) SELECT id, team_id, user_id, position, active, joined_at FROM __temp__team_member');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__game AS SELECT id, created_by_id, status, created_at, updated_at, turn_duration_sec, visibility, fen, ply, turn_team, turn_deadline, result FROM game');
        $this->addSql('DROP TABLE game');
        $this->addSql('CREATE TABLE game (id CHAR(36) NOT NULL --
(DC2Type:uuid)
        , created_by_id INTEGER DEFAULT NULL, status VARCHAR(10) NOT NULL, created_at DATETIME NOT NULL --
(DC2Type:datetime_immutable)
        , updated_at DATETIME DEFAULT NULL --
(DC2Type:datetime_immutable)
        , turn_duration_sec INTEGER NOT NULL, visibility VARCHAR(16) NOT NULL, fen CLOB NOT NULL, ply INTEGER NOT NULL, turn_team VARCHAR(1) NOT NULL, turn_deadline DATETIME DEFAULT NULL --
(DC2Type:datetime_immutable)
...
(DC2Type:json)
        ...
        $this->addSql('DROP TABLE invite');
        $this->addSql('CREATE TABLE invite (game_id CHAR(36) NOT NULL --
(DC2Type:uuid)
        , id CHAR(36) NOT NULL --
(DC2Type:uuid)
...
(DC2Type:uuid)
        , user_id INTEGER NOT NULL, position INTEGER NOT NULL, active BOOLEAN NOT NULL, joined_at DATETIME NOT NULL --
(DC2Type:datetime_immutable)
