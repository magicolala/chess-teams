...
final class Version20250831232849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , result VARCHAR(16) DEFAULT NULL, fast_mode_enabled BOOLEAN DEFAULT FALSE NOT NULL, fast_mode_deadline TIMESTAMP DEFAULT NULL --(DC2Type:datetime_immutable)
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game DROP COLUMN fast_mode_enabled');
        $this->addSql('ALTER TABLE game DROP COLUMN fast_mode_deadline');
    }
}